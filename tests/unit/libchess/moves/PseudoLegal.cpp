...
TEST_CASE("Pseudo-legal - pawn pushes", TAGS)
{
    SECTION("White")
    {
        SECTION("From starting position")
        {
            ...
            STATIC_REQUIRE_FALSE(pushes.test(Square { File::A, Rank::Three }));
        }
    ...
    SECTION("Black")
    {
        SECTION("From starting position")
        {
            ...
            STATIC_REQUIRE_FALSE(pushes.test(Square { File::C, Rank::Six }));
        }
...
TEST_CASE("Pseudo-legal - knights", TAGS)
{
    ...
    SECTION("From E4 and D4")
    {
        ...
        REQUIRE(allMoves == 0x3C6600663C00_bb);
        ...
        REQUIRE(moves == 0x342600641C00_bb);
    }
}

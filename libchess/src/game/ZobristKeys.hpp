...
static constexpr Hash BLACK_TO_MOVE { 0x679ebe6f2ed869a4ULL };

static constexpr Hash WHITE_KINGSIDE_CASTLE { 0x6b63254b15e00a87ULL };
static constexpr Hash WHITE_QUEENSIDE_CASTLE { 0x098dc1575ddbd151ULL };
static constexpr Hash BLACK_KINGSIDE_CASTLE { 0xdbb675f686df04a9ULL };
static constexpr Hash BLACK_QUEENSIDE_CASTLE { 0x71588a053b2bd9e5ULL };
